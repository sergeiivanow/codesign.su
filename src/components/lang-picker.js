...
const LangSwitcher = ({ langsMenu }) => {
  const languages = langsMenu.filter(lang => lang.selected)[0]
  return (
      <Link to={languages.langKey === "ru" ? langsMenu[1].link : langsMenu[0].link}>
        {languages.langKey === "ru" ? (
          <svg
            width="20"
